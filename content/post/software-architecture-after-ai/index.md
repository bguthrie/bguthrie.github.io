...
Software architecture has always been a fuzzy category. We know it exists—firms employ architects, ergo there is software architecture—but what exactly it constitutes has always been a matter for debate. You might reasonably argue (and I believe) that all software development is also architectural development, and to write software is to architect it. However, some decisions are harder and have more long-lasting consequences than others.
