...
The problem is that teams who aspire to be elite often confuse _markers_ of quality with quality itself, particular as end users perceive it. Do not mistake ceremony for discipline. Turning quality into a gate instead of a habit leaves you slower, not faster, because you lose the ability to iterate on process, and challenging your process is now a matter of survival. Quality gates are a difficult organizational pathology to deconstruct, because challenging them makes people worry that you're lowering the bar. This is especially exacerbated at engineering organizations that reward engineers for technical achievements rather than business impact.
