...
It does not erase coupling, migration risk, or rollout complexity, but it does _demote_ a lot of code-shaping decisions that used to feel permanent, and make the rest dramatically easier to monitor and fix. That places this kind of change squarely in the category of "not architecture anymore."
