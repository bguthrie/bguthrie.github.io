...
In the 1940s, a holding company called National City Lines — backed by General Motors, Firestone, and Standard Oil — acquired controlling interests in urban transit systems across dozens of American cities and converted their electric streetcar lines to diesel buses. They were convicted of antitrust violations in 1949. The fine was five thousand dollars.

The popular version of this story is a conspiracy: corporations deliberately destroyed public transit to sell cars and gasoline. Historians are more skeptical. Most of those streetcar systems were already failing — fare structures frozen since the 1890s, deferred wartime maintenance, postwar suburbanization making radial rail networks obsolete for dispersed travel patterns. The jury acquitted on the charge of intentional destruction. What the backers of National City Lines actually did was more structural: they ensured that when financially distressed systems failed, the replacement ran on their technology.

The historical debate about intent is the point. You don't need a conspiracy to produce systematic infrastructure capture. Aligned incentives operating on structurally vulnerable systems produce the same outcome as deliberate attack.

Model vendors don't need to attack healthy software. They need to ensure that when structurally pressured software fails, the replacement routes through inference. Stack Overflow is the case study. It was already in decline before the current wave of AI tools — search quality had improved, community moderation hadn't scaled, the product was running on accumulated habit rather than compounding value. Then Anthropic shipped inline code explanation and a segment evaporated. That's not an attack. That's an infrastructure provider ensuring the natural successor runs on tokens.

Which means the segments most exposed aren't necessarily the ones facing the most direct AI competition. They're the ones already under structural pressure — growth plateauing, users staying from inertia, switching costs doing the work the product used to do — and where the natural replacement would be inference-native. That list is different from "whatever AI is best at today," and it's longer than most people think.

## The inversion is already underway

I manage a lot of software engineers at a company that writes a lot of software. I'm not writing this from the outside.

The structural argument resolves into two questions. Is your segment worth direct attack — is there a version of your product whose core workflow converts cleanly into repeated inference calls at scale? If yes, the model vendors have both the means and the incentive to build it, subsidize it, or fund someone who will. And: is your segment already under structural pressure independent of AI — growth plateauing, users staying from inertia rather than compounding value, switching costs doing the work your product used to do? If yes, you don't need to be attacked. You just need the natural replacement to route through inference.

Most software businesses sit somewhere on at least one of these axes. The useful question isn't whether the inversion is coming. It's which mechanism gets there first.
